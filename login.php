...
?>
	<div class="formWrapper">
		<form id="loginForm">
			...
			<br>
			<br>
			<a href="<?php echo rtrim(dirname($_SERVER['PHP_SELF']), '/\\') . '/register.php'; ?>">Don't have an account? Sign Up</a>
			<br>
			<a href="<?php echo rtrim(dirname($_SERVER['PHP_SELF']), '/\\') . '/resetPassword.php'; ?>">Forgot your password? Reset it</a>
		</form>
