	...
	<?php if(empty($_GET['id']) && empty($_GET['hash'])) { ?>
		<div class="formWrapper">
			<form id="resetPasswordForm">
				...
				<br>
				<br>
				<a href="<?php echo rtrim(dirname($_SERVER['PHP_SELF']), '/\\') . '/login.php'; ?>">Remembered your password? Log In.</a>
			</form>
	...
	<?php } else { ?>
		<div class="formWrapper">
			<form id="changePasswordForm">
				...
				<br>
				<br>
				<a href="<?php echo rtrim(dirname($_SERVER['PHP_SELF']), '/\\') . '/login.php'; ?>">Go back to log in</a>
			</form>
